/* Did the Philadelphia Phillies win yesterday?
 This script checks if the Phillies won yesterday (even with a doubleheader).  This function is needed
 since after midnight it doesn't show if they won!
...
function getTodayDate() {
  ...
  month = String(yesterday.getMonth() + 1).padStart(2, "0"); // Months are zero-indexed
...
function backgroundAndTextColor(homeGame, gameHour) {
    ...
    if (today === "2026-03-26") { /*Opening Day is March 28, 2026.  This is a special case because they will be wearing pinstripes regardless of if it is a day or night game. */
...
async function runDailyReport() {
 /* const holiday = getHolidayMessage();
  ...
  if (!scheduleData.dates || scheduleData.dates.length === 0) {
    ...
    philliesResultElement.textContent = "No game scheduled yesterday";
